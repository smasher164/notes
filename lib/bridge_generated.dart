...
class BackendImpl extends FlutterRustBridgeBase<BackendWire>
    implements Backend {
  factory BackendImpl(ffi.DynamicLibrary dylib) =>
      BackendImpl.raw(BackendWire(dylib));
...
/// generated by flutter_rust_bridge
class BackendWire implements FlutterRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  BackendWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  BackendWire.fromLookup(
